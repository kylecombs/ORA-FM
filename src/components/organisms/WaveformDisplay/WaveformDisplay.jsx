...
//   playheadPos    0-1 normalised playhead position (or null)
...
export default function WaveformDisplay({
  ...
  useEffect(() => {
    ...
    // Playhead
    if (playheadPos != null && playheadPos >= 0 && playheadPos <= 1) {
      const px = Math.round(playheadPos * w);
  ...
  }, [audioData, startPos, endPos, playheadPos, accentColor, width, height, sampleName]);
