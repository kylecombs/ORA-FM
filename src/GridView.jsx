...
const NODE_SCHEMA = {
  ...
  dsaw: {
    ...
    params: {
      ...
      release: { label: 'rel',  min: 0,  max: 10,   step: 0.1,  val: 1 },
      cutoff:  { label: 'cut',  min: 30, max: 130,  step: 1,    val: 80 },
      detune:  { label: 'det',  min: 0,  max: 24,   step: 0.1,  val: 0.1 },
    },
  },
  dpulse: {
    label: 'DPulse',
    ...
    params: {
      ...
      cutoff:      { label: 'cut',  min: 30, max: 130,  step: 1,    val: 80 },
      detune:      { label: 'det',  min: 0,  max: 24,   step: 0.1,  val: 0.1 },
      pulse_width: { label: 'pw',   min: 0,  max: 1,    step: 0.01, val: 0.5 },
    },
  },
  dtri: {
    label: 'DTri',
    desc: 'detuned triangle',
    accent: '#b89a6a',
  ...
  fm: {
    ...
    params: {
      ...
      sustain: { label: 'sus',  min: 0.1,max: 9999, step: 1,    val: 9999 },
      release: { label: 'rel',  min: 0,  max: 10,   step: 0.1,  val: 1 },
      cutoff:  { label: 'cut',  min: 30, max: 130,  step: 1,    val: 100 },
      divisor: { label: 'div',  min: 0.1,max: 20,   step: 0.1,  val: 2 },
      depth:   { label: 'dep',  min: 0,  max: 10,   step: 0.1,  val: 1 },
    },
  },
  dull_bell: {
    label: 'Dull Bell',
  ...
  growl: {
    ...
    desc: 'growling bass',
    accent: '#c08880',
    synthDef: 'sonic-pi-growl',
    inputs: [],
    outputs: ['out'],
    params: {
      note:    { label: 'note', min: 24, max: 96,   step: 1,    val: 48 },
      amp:     { label: 'amp',  min: 0,  max: 1,    step: 0.01, val: 0.2 },
      attack:  { label: 'atk',  min: 0,  max: 5,    step: 0.1,  val: 0.1 },
      sustain: { label: 'sus',  min: 0.1,max: 9999, step: 1,    val: 9999 },
      release: { label: 'rel',  min: 0,  max: 10,   step: 0.1,  val: 1 },
  ...
  hoover: {
    ...
    params: {
      ...
      sustain: { label: 'sus',  min: 0.1,max: 9999, step: 1,    val: 9999 },
      release: { label: 'rel',  min: 0,  max: 10,   step: 0.1,  val: 1 },
      cutoff:  { label: 'cut',  min: 30, max: 130,  step: 1,    val: 130 },
    },
  },
  kalimba: {
    label: 'Kalimba',
    ...
    params: {
      note:    { label: 'note', min: 24, max: 96,   step: 1,    val: 72 },
      amp:     { label: 'amp',  min: 0,  max: 1,    step: 0.01, val: 0.5 },
      attack:  { label: 'atk',  min: 0,  max: 2,    step: 0.01, val: 0 },
      sustain: { label: 'sus',  min: 0,  max: 9999, step: 1,    val: 9999 },
      release: { label: 'rel',  min: 0,  max: 10,   step: 0.1,  val: 2 },
    },
  },
  organ: {
    ...
    params: {
      note:    { label: 'note', min: 24, max: 96,   step: 1,    val: 60 },
      amp:     { label: 'amp',  min: 0,  max: 1,    step: 0.01, val: 0.3 },
      attack:  { label: 'atk',  min: 0,  max: 5,    step: 0.1,  val: 0.01 },
      sustain: { label: 'sus',  min: 0.1,max: 9999, step: 1,    val: 9999 },
      release: { label: 'rel',  min: 0,  max: 10,   step: 0.1,  val: 1 },
    },
  },
  piano: {
    ...
    params: {
      ...
      sustain:      { label: 'sus',  min: 0,  max: 9999,step: 1,    val: 9999 },
      release:      { label: 'rel',  min: 0,  max: 10,  step: 0.1,  val: 1 },
      vel:          { label: 'vel',  min: 0,  max: 1,   step: 0.01, val: 0.7 },
      hard:         { label: 'hard', min: 0,  max: 1,   step: 0.01, val: 0.5 },
      stereo_width: { label: 'wide', min: 0,  max: 1,   step: 0.01, val: 0 },
    },
  },
  prophet: {
    label: 'Prophet',
    ...
    params: {
      ...
      release: { label: 'rel',  min: 0,  max: 10,   step: 0.1,  val: 1 },
      cutoff:  { label: 'cut',  min: 30, max: 130,  step: 1,    val: 80 },
      res:     { label: 'res',  min: 0,  max: 1,    step: 0.01, val: 0.7 },
    },
  },
  pulse_synth: {
    label: 'Pulse',
  ...
  subpulse: {
    ...
    params: {
      ...
      release:     { label: 'rel',   min: 0,  max: 10,   step: 0.1,  val: 1 },
      cutoff:      { label: 'cut',   min: 30, max: 130,  step: 1,    val: 80 },
      sub_amp:     { label: 'sub',   min: 0,  max: 1,    step: 0.01, val: 1 },
      sub_detune:  { label: 's.det', min: -5, max: 5,    step: 0.01, val: -12 },
      pulse_width: { label: 'pw',    min: 0,  max: 1,    step: 0.01, val: 0.5 },
    },
  },
  supersaw: {
  ...
  tb303: {
    ...
    params: {
      ...
      release:    { label: 'rel',   min: 0,  max: 10,   step: 0.1,  val: 1 },
      cutoff:     { label: 'cut',   min: 30, max: 130,  step: 1,    val: 80 },
      cutoff_min: { label: 'c.min', min: 30, max: 130,  step: 1,    val: 30 },
      res:        { label: 'res',   min: 0,  max: 1,    step: 0.01, val: 0.9 },
      wave:       { label: 'wave',  min: 0,  max: 2,    step: 1,    val: 0 },
    },
  },
  tech_saws: {
    label: 'TechSaws',
  ...
  zawa: {
    ...
    params: {
      ...
      cutoff:  { label: 'cut',   min: 30, max: 130,  step: 1,    val: 80 },
      res:     { label: 'res',   min: 0,  max: 1,    step: 0.01, val: 0.9 },
      phase:   { label: 'phase', min: 0,  max: 10,   step: 0.1,  val: 1 },
      range:   { label: 'range', min: 0,  max: 90,   step: 1,    val: 24 },
    },
  },
  rodeo: {
    label: 'Rodeo',
  ...
  bass_foundation: {
    label: 'Bass',
    desc: 'foundation bass',
    accent: '#c08880',
    synthDef: 'sonic-pi-bass_foundation',
    inputs: [],
    outputs: ['out'],
    params: {
      note:    { label: 'note', min: 24, max: 72,   step: 1,    val: 40 },
      amp:     { label: 'amp',  min: 0,  max: 1,    step: 0.01, val: 0.3 },
      attack:  { label: 'atk',  min: 0,  max: 5,    step: 0.1,  val: 0.01 },
      sustain: { label: 'sus',  min: 0.1,max: 9999, step: 1,    val: 9999 },
      release: { label: 'rel',  min: 0,  max: 10,   step: 0.1,  val: 1 },
      cutoff:  { label: 'cut',  min: 30, max: 130,  step: 1,    val: 70 },
    },
  },
  bass_highend: {
    label: 'HiBass',
    ...
    params: {
      ...
      release: { label: 'rel',  min: 0,  max: 10,   step: 0.1,  val: 1 },
      cutoff:  { label: 'cut',  min: 30, max: 130,  step: 1,    val: 80 },
      drive:   { label: 'drv',  min: 0,  max: 1,    step: 0.01, val: 0.5 },
    },
  },
  // ── Chiptune synths ────────────────────────────────────
  chipbass: {
  ...
  chiplead: {
    ...
    params: {
      ...
      sustain: { label: 'sus',   min: 0.1,max: 9999,step: 1,   val: 9999 },
      release: { label: 'rel',   min: 0,  max: 5,  step: 0.1,  val: 1 },
      width:   { label: 'width', min: 0,  max: 1,  step: 0.01, val: 0 },
    },
  },
  chipnoise: {
    label: 'ChipNoise',
    ...
    params: {
      ...
      sustain:   { label: 'sus',  min: 0.1,max: 9999,step: 1,  val: 9999 },
      release:   { label: 'rel',  min: 0, max: 5,  step: 0.1,  val: 1 },
      freq_band: { label: 'band', min: 0, max: 15, step: 1,    val: 0 },
    },
  },
  gabberkick: {
    label: 'Gabber',
    desc: 'gabber kick',
    accent: '#c08880',
    synthDef: 'sonic-pi-gabberkick',
    inputs: [],
    outputs: ['out'],
    params: {
      note:    { label: 'note', min: 24, max: 96, step: 1,    val: 40 },
      amp:     { label: 'amp',  min: 0,  max: 1,  step: 0.01, val: 0.3 },
      attack:  { label: 'atk',  min: 0,  max: 2,  step: 0.01, val: 0 },
      sustain: { label: 'sus',  min: 0.1,max: 9999,step: 1,   val: 9999 },
      release: { label: 'rel',  min: 0,  max: 5,  step: 0.1,  val: 1 },
  ...
  // ── Additional noise synths ────────────────────────────
  cnoise: {
    label: 'C Noise',
    desc: 'clip noise',
    accent: '#c08880',
    synthDef: 'sonic-pi-cnoise',
    inputs: [],
    outputs: ['out'],
    params: {
      amp:     { label: 'amp', min: 0,   max: 1,    step: 0.01, val: 0.08 },
  ...
  mod_sine: {
    ...
    params: {
      ...
      release:   { label: 'rel',     min: 0,  max: 10,   step: 0.1,  val: 1 },
      cutoff:    { label: 'cut',     min: 30, max: 130,  step: 1,    val: 100 },
      mod_phase: { label: 'mod.ph',  min: 0,  max: 10,   step: 0.1,  val: 0.25 },
      mod_range: { label: 'mod.rng', min: 0,  max: 72,   step: 1,    val: 5 },
      mod_wave:  { label: 'mod.w',   min: 0,  max: 3,    step: 1,    val: 1 },
    },
  },
  mod_saw: {
    label: 'Mod Saw',
  ...
  mod_tri: {
    label: 'Mod Tri',
    desc: 'modulated triangle',
    accent: '#8ab0c8',
    synthDef: 'sonic-pi-mod_tri',
    inputs: [],
    outputs: ['out'],
    params: {
      note:      { label: 'note',    min: 24, max: 96,   step: 1,    val: 60 },
  ...
  mod_pulse: {
    label: 'Mod Pulse',
    desc: 'modulated pulse',
    accent: '#8ab0c8',
    synthDef: 'sonic-pi-mod_pulse',
    inputs: [],
    outputs: ['out'],
    params: {
      note:        { label: 'note',    min: 24, max: 96,   step: 1,    val: 60 },
  ...
  mod_dsaw: {
    label: 'Mod DSaw',
    desc: 'mod detuned saw',
    accent: '#8ab0c8',
    synthDef: 'sonic-pi-mod_dsaw',
    inputs: [],
    outputs: ['out'],
    params: {
      note:      { label: 'note',    min: 24, max: 96,   step: 1,    val: 60 },
  ...
  sc808_kick: {
    ...
    params: {
      note:    { label: 'note', min: 24, max: 72, step: 1,    val: 40 },
      amp:     { label: 'amp',  min: 0,  max: 1,  step: 0.01, val: 0.5 },
      attack:  { label: 'atk',  min: 0,  max: 1,  step: 0.01, val: 0 },
      sustain: { label: 'sus',  min: 0.1,max: 9999,step: 1,   val: 9999 },
      release: { label: 'rel',  min: 0,  max: 5,  step: 0.1,  val: 1 },
    },
  },
  sc808_snare: {
    ...
    params: {
      ...
      attack:  { label: 'atk',  min: 0,  max: 1,  step: 0.01, val: 0 },
      sustain: { label: 'sus',  min: 0.1,max: 9999,step: 1,   val: 9999 },
      release: { label: 'rel',  min: 0,  max: 5,  step: 0.1,  val: 0.5 },
    },
  },
  sc808_clap: {
    label: '808 Clap',
  ...
  sc808_closed_hh: {
    ...
    params: {
      ...
      attack:  { label: 'atk',  min: 0,  max: 1,  step: 0.01, val: 0 },
      sustain: { label: 'sus',  min: 0.1,max: 9999,step: 1,   val: 9999 },
      release: { label: 'rel',  min: 0,  max: 5,  step: 0.1,  val: 0.3 },
    },
  },
  sc808_open_hh: {
    label: '808 OHH',
    ...
    params: {
      ...
      attack:  { label: 'atk',  min: 0,  max: 1,  step: 0.01, val: 0 },
      sustain: { label: 'sus',  min: 0.1,max: 9999,step: 1,   val: 9999 },
      release: { label: 'rel',  min: 0,  max: 5,  step: 0.1,  val: 0.8 },
    },
  },
  sc808_cymbal: {
    label: '808 Cym',
  ...
  sc808_maracas: {
    ...
    params: {
      ...
      attack:  { label: 'atk', min: 0,   max: 1,    step: 0.01, val: 0 },
      sustain: { label: 'sus', min: 0.1, max: 9999, step: 1,    val: 9999 },
      release: { label: 'rel', min: 0,   max: 5,    step: 0.1,  val: 0.2 },
    },
  },
  sc808_rimshot: {
    label: '808 Rim',
  ...
  fx_bitcrusher: {
    ...
    params: {
      mix:         { label: 'mix',   min: 0,   max: 1,     step: 0.01, val: 1 },
      bits:        { label: 'bits',  min: 1,   max: 16,    step: 1,    val: 8 },
      sample_rate: { label: 's.rate',min: 100, max: 44100, step: 100,  val: 10000 },
    },
  },
  fx_krush: {
    label: 'Krush',
    ...
    params: {
      mix:    { label: 'mix',  min: 0,  max: 1,   step: 0.01, val: 1 },
      gain:   { label: 'gain', min: 0,  max: 20,  step: 0.1,  val: 5 },
      cutoff: { label: 'cut',  min: 0,  max: 130, step: 1,    val: 100 },
    },
  },
  fx_tanh: {
    label: 'Tanh',
    desc: 'tanh distortion',
    accent: '#bf7a7a',
    synthDef: 'sonic-pi-fx_tanh',
    category: 'fx',
    inputs: ['in'],
    outputs: ['out'],
    params: {
      mix:    { label: 'mix',    min: 0, max: 1,  step: 0.01, val: 1 },
      krunch: { label: 'krunch', min: 0, max: 20, step: 0.1,  val: 5 },
    },
  },
  fx_compressor: {
    label: 'Compress',
    ...
    params: {
      mix:         { label: 'mix',   min: 0,     max: 1, step: 0.01,  val: 1 },
      threshold:   { label: 'thresh',min: 0,     max: 1, step: 0.01,  val: 0.2 },
      clamp_time:  { label: 'clamp', min: 0.001, max: 1, step: 0.001, val: 0.01 },
      slope_above: { label: 'above', min: 0,     max: 1, step: 0.01,  val: 0.5 },
      slope_below: { label: 'below', min: 0,     max: 1, step: 0.01,  val: 1 },
      relax_time:  { label: 'relax', min: 0.001, max: 1, step: 0.001, val: 0.01 },
    },
  },
  fx_band_eq: {
    label: 'Band EQ',
    desc: 'band equalizer',
    accent: '#9b7abf',
    synthDef: 'sonic-pi-fx_band_eq',
    category: 'fx',
    inputs: ['in'],
    outputs: ['out'],
    params: {
      mix:  { label: 'mix',  min: 0,   max: 1,     step: 0.01, val: 1 },
      freq: { label: 'freq', min: 20,  max: 20000, step: 1,    val: 1000 },
      res:  { label: 'res',  min: 0.01,max: 1,     step: 0.01, val: 0.6 },
      db:   { label: 'dB',   min: -24, max: 24,    step: 0.5,  val: 0 },
    },
  },
  fx_gverb: {
    label: 'GVerb',
    desc: 'granular reverb',
    accent: '#9b7abf',
    ...
    params: {
      mix:        { label: 'mix',  min: 0,   max: 1,   step: 0.01, val: 0.4 },
      room:       { label: 'room', min: 0.1, max: 300, step: 1,    val: 10 },
      release:    { label: 'rel',  min: 0,   max: 10,  step: 0.1,  val: 3 },
      damp:       { label: 'damp', min: 0,   max: 1,   step: 0.01, val: 0.5 },
      ref_level:  { label: 'ref',  min: 0,   max: 1,   step: 0.01, val: 0.7 },
      tail_level: { label: 'tail', min: 0,   max: 1,   step: 0.01, val: 0.5 },
    },
  },
  fx_ping_pong: {
    label: 'PingPong',
    ...
    params: {
      mix:       { label: 'mix',  min: 0,    max: 1, step: 0.01, val: 1 },
      phase:     { label: 'time', min: 0.01, max: 4, step: 0.01, val: 0.25 },
      feedback:  { label: 'fb',   min: 0,    max: 1, step: 0.01, val: 0.5 },
      max_phase: { label: 'max',  min: 0.01, max: 4, step: 0.01, val: 1 },
    },
  },
  fx_tremolo: {
    label: 'Tremolo',
    ...
    params: {
      mix:   { label: 'mix',   min: 0, max: 1,  step: 0.01, val: 1 },
      phase: { label: 'phase', min: 0, max: 10, step: 0.1,  val: 4 },
      depth: { label: 'depth', min: 0, max: 1,  step: 0.01, val: 0.5 },
      wave:  { label: 'wave',  min: 0, max: 3,  step: 1,    val: 2 },
    },
  },
  fx_slicer: {
    label: 'Slicer',
    desc: 'amplitude slicer',
    accent: '#7abfbf',
    ...
    params: {
      mix:     { label: 'mix',   min: 0, max: 1,  step: 0.01, val: 1 },
      phase:   { label: 'phase', min: 0, max: 10, step: 0.1,  val: 0.25 },
      amp_min: { label: 'a.min', min: 0, max: 1,  step: 0.01, val: 0 },
      amp_max: { label: 'a.max', min: 0, max: 1,  step: 0.01, val: 1 },
      wave:    { label: 'wave',  min: 0, max: 3,  step: 1,    val: 1 },
    },
  },
  fx_panslicer: {
    label: 'PanSlice',
    desc: 'pan slicer',
    accent: '#7abfbf',
    synthDef: 'sonic-pi-fx_panslicer',
    category: 'fx',
    inputs: ['in'],
    outputs: ['out'],
    params: {
      mix:     { label: 'mix',   min: 0,  max: 1,  step: 0.01, val: 1 },
      phase:   { label: 'phase', min: 0,  max: 10, step: 0.1,  val: 0.25 },
      pan_min: { label: 'p.min', min: -1, max: 1,  step: 0.01, val: -1 },
      pan_max: { label: 'p.max', min: -1, max: 1,  step: 0.01, val: 1 },
      wave:    { label: 'wave',  min: 0,  max: 3,  step: 1,    val: 1 },
    },
  },
  fx_wobble: {
    ...
    params: {
      mix:        { label: 'mix',   min: 0, max: 1,   step: 0.01, val: 1 },
      phase:      { label: 'phase', min: 0, max: 10,  step: 0.1,  val: 0.5 },
      cutoff_min: { label: 'c.min', min: 0, max: 130, step: 1,    val: 60 },
      cutoff_max: { label: 'c.max', min: 0, max: 130, step: 1,    val: 120 },
      res:        { label: 'res',   min: 0, max: 1,   step: 0.01, val: 0.8 },
      wave:       { label: 'wave',  min: 0, max: 3,   step: 1,    val: 0 },
    },
  },
  fx_ixi_techno: {
    label: 'IxiTech',
    desc: 'ixi techno',
    accent: '#7abfbf',
    synthDef: 'sonic-pi-fx_ixi_techno',
    category: 'fx',
    inputs: ['in'],
    outputs: ['out'],
    params: {
  ...
  fx_ring_mod: {
    ...
    desc: 'ring modulator',
    accent: '#7abfbf',
    synthDef: 'sonic-pi-fx_ring_mod',
    category: 'fx',
    inputs: ['in'],
    outputs: ['out'],
    params: {
      mix:     { label: 'mix',  min: 0, max: 1,    step: 0.01, val: 1 },
      freq:    { label: 'freq', min: 0, max: 5000, step: 1,    val: 30 },
      mod_amp: { label: 'mod',  min: 0, max: 1,    step: 0.01, val: 1 },
    },
  },
  fx_vowel: {
    label: 'Vowel',
    desc: 'vowel filter',
    accent: '#7abfbf',
    synthDef: 'sonic-pi-fx_vowel',
    category: 'fx',
    inputs: ['in'],
    outputs: ['out'],
    params: {
      mix:          { label: 'mix',   min: 0, max: 1, step: 0.01, val: 1 },
      vowel_sound:  { label: 'vowel', min: 1, max: 5, step: 1,    val: 1 },
      voice:        { label: 'voice', min: 0, max: 4, step: 1,    val: 0 },
    },
  },
  fx_octaver: {
    label: 'Octaver',
    desc: 'octave shift',
    accent: '#9b7abf',
    synthDef: 'sonic-pi-fx_octaver',
    category: 'fx',
    inputs: ['in'],
    outputs: ['out'],
    params: {
      mix:       { label: 'mix', min: 0, max: 1, step: 0.01, val: 1 },
      super_amp: { label: 'sup', min: 0, max: 1, step: 0.01, val: 1 },
      sub_amp:   { label: 'sub', min: 0, max: 1, step: 0.01, val: 1 },
    },
  },
  fx_pan: {
    ...
    desc: 'stereo panner',
    accent: '#9b7abf',
    synthDef: 'sonic-pi-fx_pan',
    category: 'fx',
    inputs: ['in'],
    outputs: ['out'],
    params: {
      mix: { label: 'mix', min: 0,  max: 1, step: 0.01, val: 1 },
      pan: { label: 'pan', min: -1, max: 1, step: 0.01, val: 0 },
    },
  },
  fx_pitch_shift: {
    label: 'PShift',
    desc: 'pitch shifter',
    accent: '#9b7abf',
    synthDef: 'sonic-pi-fx_pitch_shift',
    category: 'fx',
    inputs: ['in'],
    outputs: ['out'],
    params: {
      mix:         { label: 'mix',   min: 0,     max: 1,  step: 0.01,  val: 1 },
      pitch:       { label: 'pitch', min: -24,   max: 24, step: 0.1,   val: 0 },
      window_size: { label: 'win',   min: 0.001, max: 1,  step: 0.001, val: 0.2 },
      pitch_dis:   { label: 'p.dis', min: 0,     max: 0.1,step: 0.001, val: 0.0 },
      time_dis:    { label: 't.dis', min: 0,     max: 0.1,step: 0.001, val: 0.0 },
    },
  },
  fx_whammy: {
    label: 'Whammy',
    desc: 'pitch bend',
    accent: '#9b7abf',
    synthDef: 'sonic-pi-fx_whammy',
    category: 'fx',
    inputs: ['in'],
    outputs: ['out'],
    params: {
      mix:            { label: 'mix',   min: 0,     max: 1,  step: 0.01,  val: 1 },
      transpose:      { label: 'semi',  min: -24,   max: 24, step: 1,     val: 12 },
      max_delay_time: { label: 'delay', min: 0.001, max: 1,  step: 0.001, val: 0.125 },
      grainsize:      { label: 'grain', min: 0.001, max: 0.5,step: 0.001, val: 0.075 },
    },
  },
  // ── Utility modules ─────────────────────────────────────
  multiply: {
...
const MODULE_CATEGORIES = [
  {
    ...
    types: ['sine', 'sine_osc', 'saw', 'saw_osc', 'pulse_osc', 'tri_osc', 'blip_osc', 'formant_osc', 'square_synth', 'pulse_synth', 'tri_synth'],
  },
  {
    id: 'noise',
    label: 'Noise',
    desc: 'noise generators',
    types: ['dust_osc', 'crackle_osc', 'white_noise_osc', 'pink_noise_osc', 'lfnoise0_osc', 'lfnoise1_osc', 'lfnoise2_osc'],
  },
  {
    id: 'instruments',
    label: 'Instruments',
    desc: 'melodic voices',
    types: ['bell', 'dull_bell', 'blade', 'pluck', 'piano', 'rhodey', 'kalimba', 'organ', 'prophet', 'fm'],
  },
  {
    id: 'synths',
    label: 'Synths',
    desc: 'classic synths',
    types: ['dsaw', 'dpulse', 'dtri', 'supersaw', 'tech_saws', 'rodeo', 'hoover', 'growl', 'zawa', 'subpulse'],
  },
  {
    id: 'bass',
    label: 'Bass',
    desc: 'bass synths',
    types: ['bass_foundation', 'bass_highend', 'tb303'],
  },
  {
    id: 'modulated',
    label: 'Modulated',
    desc: 'LFO-modulated synths',
    types: ['mod_sine', 'mod_saw', 'mod_tri', 'mod_pulse', 'mod_dsaw', 'mod_fm'],
  },
  {
    id: 'chip',
    label: 'Chiptune',
    desc: 'retro sounds',
    types: ['chipbass', 'chiplead', 'chipnoise', 'gabberkick'],
  },
  {
    id: 'textures',
    label: 'Textures',
    desc: 'pads & noise',
    types: ['pad', 'hollow', 'noise', 'cnoise', 'gnoise', 'noise_sp', 'pnoise'],
  },
  {
    id: 'drums',
    label: 'Drums',
    desc: '808 drum machine',
    types: ['sc808_kick', 'sc808_snare', 'sc808_clap', 'sc808_closed_hh', 'sc808_open_hh', 'sc808_cymbal', 'sc808_cowbell', 'sc808_claves', 'sc808_maracas', 'sc808_rimshot', 'sc808_congahi', 'sc808_congamid', 'sc808_congalo', 'sc808_tomhi', 'sc808_tommid', 'sc808_tomlo'],
  },
  {
    id: 'filters',
    label: 'Filters',
  ...
  },
  {
    ...
    label: 'Effects',
    desc: 'time & space',
    types: ['fx_reverb', 'fx_gverb', 'fx_echo', 'fx_ping_pong', 'fx_flanger', 'fx_tremolo', 'fx_slicer', 'fx_panslicer', 'fx_wobble', 'fx_ixi_techno', 'fx_ring_mod', 'fx_vowel', 'fx_pan', 'fx_pitch_shift', 'fx_whammy', 'fx_octaver'],
  },
  {
    id: 'distortion',
    label: 'Distortion',
    desc: 'drive & crush',
    types: ['fx_distortion', 'fx_bitcrusher', 'fx_krush', 'fx_tanh'],
  },
  {
    id: 'dynamics',
    label: 'Dynamics',
    desc: 'compression & EQ',
    types: ['fx_compressor', 'fx_band_eq'],
  },
  {
    id: 'utility',
    label: 'Utility',
